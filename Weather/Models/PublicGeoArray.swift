//
//  PublicGeoArray.swift
//  Weather
//
//  Created by Арсений Кухарев on 08.08.2023.
//

import Foundation

class PublicGeoArray {
   static var savedCities = [GeoResponce(nameOfLocation: "Гомель", localizedNames: nil, lat: 52.36, lon: 31, country: "РБ", state: "Гомельская область"),
